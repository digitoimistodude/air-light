...
gulp.task("watch", ["browsersync"], function () {
  gulp.watch(sassSrc, ["styles", "scss-lint"]); // If you want gulp to handle auto styling, add .on( 'change', stylefmtfile ), but we prefer Sublime Text/VSCode package Stylefmt to handle this for you.
  gulp.watch(phpSrc, ["phpcs"]); // If you prefer validate HTML on the fly, add "validatehtml" and "a11y" to tasks. Can be resource intensive.
