...
newestphp="7.2"
currentdate="LC_TIME=en_US date '+%d %b %Y'";
datewithunderscores="${currentdate} |tr ' ' '_'"
echo "# ${PROJECTNAME}
![based_on_air_version ${newestair}_](https://img.shields.io/badge/based_on_air_version-${newestair}_-brightgreen.svg?style=flat-square) ![project_created ${datewithunderscores}](https://img.shields.io/badge/project_created-${datewithunderscores}-blue.svg?style=flat-square) ![Tested_up_to WordPress_${newestwordpress}](https://img.shields.io/badge/Tested_up_to-WordPress_${newestwordpress}-blue.svg?style=flat-square) ![Compatible_with PHP_${newestphp}](https://img.shields.io/badge/Compatible_with-PHP_${newestphp}-green.svg?style=flat-square)
